...
```{r}
ggplot(midwest, aes(x = percbelowpoverty, y = percollege, color = state, shape = state)) +
  geom_point() +
  labs(
    color = "State",
    shape = "State",
